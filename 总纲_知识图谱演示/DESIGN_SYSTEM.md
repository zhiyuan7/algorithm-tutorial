...
用户提供的配色图是唯一颜色来源。主背景采用暖黄 `#D6BF88`，金黄 `#D7B662` 只用于小面积辅助。
...
| `--blue` | `#163F6F` | 当前知识点与科学循环 |
| `--teal` | `#396D80` | 建模、自然科学 |
| `--sky` | `#74A0BA` | 辅助蓝 |
| `--cyan` | `#83D0E3` | 封面环线 |
| `--sage` | `#7D8981` | 次级文本与非当前边 |
| `--green` | `#9AAE8F` | 形式向现实的应用 |
| `--plum` | `#624F6B` | 理论、形式科学 |
| `--wine` | `#644A56` | 哥德尔不完备性 |
| `--tan` | `#BA9A7E` | 辅助注释 |
...
| Graph Morph | 1200 ms | 同上 | 从科学循环转向科学范式 |
...
两张知识图谱在数据上保持独立。`ParadigmMorph.vue` 只是中间镜头：
